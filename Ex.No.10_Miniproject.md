...
To develop a 2D Flappy-Bird style game where the player controls a character that jumps to avoid obstacles, earns points by passing through
gaps, and restarts the game upon collision while tracking the best score.
...
```
## Output:
<img width="1187" height="664" alt="image" src="https://github.com/user-attachments/assets/914d0d6c-7d0c-45ed-8410-a84cadc48fbd" />
